...
Room.create(:name => 'marker_green_A', :marker => "36.766344, 127.284448", :title => '그린하우스 A동', :structure => "13(방1, 화장실1)", :period => '6', :payment => '170', :fee => '21', :deposit => '50', :phone_num => '010-2696-5805')
Room.create(:name => 'marker_green_B', :marker => "36.766258, 127.284748", :title => '그린하우스 B동', :structure => "10(방1, 화장실1)", :period => '6', :payment => '240', :fee => '21', :deposit => '50', :phone_num => '010-2696-5805')
Room.create(:name => 'marker_green_C', :marker => "36.766017, 127.284662", :title => '그린하우스 C동', :structure => "13(방1, 화장실1)", :period => '6', :payment => '170', :fee => '21', :deposit => '50', :phone_num => '010-2696-5805')
...
Room.create(:name => 'marker_happy_B', :marker => "36.770345, 127.287010", :title => '행복한원룸 A동', :structure => "9평(방1, 화장실1)", :period => '6', :payment => '200', :fee => '20', :deposit => '30', :phone_num => '010-5353-0189')
